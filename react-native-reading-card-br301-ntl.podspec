...
# Updated Folly version for React Native 0.81+ (compatible with latest packages)
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/Nattawut1994/react-native-reading-card-br301.git", :tag => "#{s.version}" }
